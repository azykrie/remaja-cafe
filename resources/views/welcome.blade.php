  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div class="logo me-auto">
        <h1><a href="index.html">Remaja Cafe</a></h1>
      ...
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-3.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Remaja</span> Cafe</h2>
                <p class="animate__animated animate__fadeInUp">Tempat sntai kumpul bareng teman teman</p>
                <!-- <div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/slide/slide-5.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Remaja kesini</h2>
                <!-- <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Menu</a>
                  <a href="#book-a-table" class="btn-book animate__animated animate__fadeInUp scrollto">Book a Table</a>
                </div> -->
  ...
  <main id="main">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch">
            ...
            <div class="content">
              <h3>About <strong>Remaja Cafe</strong></h3>
              <p>
                Remaja Cafe adalah tempat ngopi sanatai penuh dengan anak remaja maupun keluarga.
              </p>
              <p class="fst-italic">
                Remaja cafe menyajikan beberapa hal yaitu :
              </p>
              <ul>
                <li><i class="bx bx-check-double"></i> Cafe yang ramah. </li>
                <li><i class="bx bx-check-double"></i> Banyak makanan dan minumannya.</li>
                <li><i class="bx bx-check-double"></i> Ramai dengan anak remaja.</li>
              </ul>
            </div>
    ...
    <section id="why-us" class="why-us">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Kenapa <span>Remaja Cafe</span></h2>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              <span>02</span>
              <h4>Mudah mendapatkan teman mau pun pacar</h4>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              ...
              <p>Cafe dengan makanan dan minuman yang sangat enak dan banyak</p>
            </div>
          </div>
    ...
    <section id="gallery" class="gallery">
      <div class="container-fluid">
        ...
        <div class="section-title">
          <h2>Beberapa foto <span>Remaja Cafe</span></h2>
        </div>
        ...
        <div class="info-wrap">
          <div class="row">
            <div class="col-lg-3 col-md-6 info">
              ...
              <h4>Location:</h4>
              <p>Cicurug<br>Cicurug - Sukabumi Jawa Barat</p>
            </div>
            ...
            <div class="col-lg-3 col-md-6 info mt-4 mt-lg-0">
              ...
              <h4>Email:</h4>
              <p>cicurugadmin@gmail.com<br>cicurugadmin@gmail.com</p>
            </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="social-links">
        <a href="https://twitter.com/azykrie" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="#" class="whatsapp"><i class="bx bxl-whatsapp"></i></a>
        <a href="https://www.instagram.com/dhyklll" class="instagram"><i class="bx bxl-instagram"></i></a>
        <a href="https://github.com/azykrie" class="github"><i class="bx bxl-github"></i></a>
